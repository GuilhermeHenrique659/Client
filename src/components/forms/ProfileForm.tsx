...
export default function ProfileForm(props: IProfileFormProps) {
    ...
    return (
        <div>
            {disableForm ? (
                <Button className="m-4" onClick={() => setDisableForm(false)}>
                    <svg
            ...
            <form className="m-2" onSubmit={handleSubmitProfileForm}>
                ...
                {!disableForm ? (
                    <>
                        ...
                        <Input
                            ...
                            label="Confirme sua antiga senha"
                            type="password"
                            value={passwordToConfirm}
                            onChange={setPasswordToConfirm}
                        />
                        <hr className="border-gray-500 w-full p-1 m-2" />
                    </>
                ) : (
                ...
                {!disableForm ? (
                    <div className="m-4">
                        ...
                        <Button className="bg-indigo-800 m-2" disable={loading}>
                            Salvar
                        </Button>
                    </div>
                ) : (
